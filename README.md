...
|------|------|------|------|----------|
| 俄罗斯方块 | Web 游戏 | ✅ 已完成 | — | — |
| DevKit 开发者工具站 | Web 工具平台（14 个工具） | ✅ 已上线 | [l-s-c/devkit](https://github.com/l-s-c/devkit) | [GitHub Pages](https://l-s-c.github.io/devkit/)（域名备案中） |
| 简压照片缩图 | 微信小程序 | ⏳ 审核中 | — | 微信搜索"简压照片缩图" |
